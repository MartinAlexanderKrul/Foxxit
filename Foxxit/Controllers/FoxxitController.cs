...
namespace Foxxit.Controllers
{
    ...
    public class FoxxitController : MainController
    {
        ...
        public async Task<IActionResult> Subreddit([FromRoute]int subRedditId)
        {
            ...
            {
                new Post() { User = currentUser,  Id = 1,  SubReddit = new SubReddit() { Name = "Greetgtgtgtgtn Fox", Id = 4 }, Title = "Green Fox", Text = "fwafawfajwfjawifjawkjfkawfnkjawh faw jakwfj kawfjj kawf jkawhf jkawhnfk " },
